...
type OrderColumns struct {
	...
	OrderSupplier     string // 订单供应商
	OrderSupplierName string // 订单供应商名称
	OrderCustomer     string // 订单客户
	OrderCustomerName string // 订单客户名称
...
var orderColumns = OrderColumns{
	...
	OrderSupplier:     "order_supplier",
	OrderSupplierName: "order_supplier_name",
